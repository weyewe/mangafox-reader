Ext.define('AM.controller.Chapters', {
  extend: 'Ext.app.Controller',

  stores: ['Comics', 'Chapters'],
  models: ['Chapter'],
  ...
  views: [
    ...
    'master.chapter.Form',
  	...
  	refs: [
		{
			ref : "wrapper",
			selector : "chapterProcess"
		},
		{
			ref : 'parentList',
			selector : 'chapterProcess mastercomicList'
		},
		{
			ref: 'list',
		...
		{
			ref : 'searchField',
			selector: 'chapterlist textfield[name=searchField]'
		}
	],
  ...
  init: function() {
    this.control({
			...
			'chapterlist button[action=openChapter]': {
        click: this.openChapter
			}	,
			
			
			'chapterProcess mastercomicList' : {
      ...
      'chapterform button[action=save]': {
        click: this.updateObject
      },
      'chapterlist button[action=addObject]': {
        click: this.addObject
      },
      'chapterlist button[action=editObject]': {
        click: this.editObject
      },
      'chapterlist button[action=deleteObject]': {
        click: this.deleteObject
      },
			'chapterProcess mastercomicList textfield[name=searchField]': {
        change: this.liveSearch
      },

			'chapterlist button[action=deactivateObject]': {
	...
	onDestroy: function(){
		...
		this.getChaptersStore().loadData([],false);
	},
  ...
  addObject: function() {
		...
		if( parentObject) {
			var view = Ext.widget('chapterform');
			view.show();
...
// console.log( values );
		...
		if( record ){
			...
			var me  = this; 
			var newObject = new AM.model.Chapter( values ) ;
...
// to do refresh programmatically
  ...
  selectionChange: function(selectionModel, selections) {
	...
	openChapter: function(){
		...
		window.open( 'show_chapter/'+id, "_blank" );
